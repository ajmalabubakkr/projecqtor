...
if ($objectClass=='Replan' or $objectClass=='Construction' or $objectClass=='Fixed') {
  $objectClass='Project';
}
if (! $objectClass or pq_strtolower($objectClass)=='null') {
  echo "{ }";
  exit;
}
...
}else if(isset($_REQUEST['objectIdRow']) and isset($_REQUEST['editRowMode'])){
  $objectId=$_REQUEST['objectIdRow'];
}
...
}else if(isset($_REQUEST['id'.$objectClass.'PlanningMode']) and isset($_REQUEST['editRowMode'])){
  $planningMode=$_REQUEST['id'.$objectClass.'PlanningMode'];
}
